...
const mainLoop = async (providers: CounterProviders, rli: Interface, wallet: Wallet & Resource): Promise<void> => {
  ...
  while (true) {
    ...
    switch (choice) {
      ...
      case '3':
        ...
        return;
      case '4':
        await api.transferNativeAsset(wallet, 'mn_shield-addr_test1t3t376pazp0h5autxnxlhxku0rlegwdnaty7gvjm8dvcqayw5x4sxqzh4xyrntr5zzlwj7k3hfxradw488xj4z9ah0r654a0ewlq55tzkya2wp5kqy577dnajk65jv2h83wp6qqkqc6jh4q2qswz4j', 1n);
        return;
      default:
        logger.error(`Invalid choice: ${choice}`);
    }
...
export const run = async (config: Config, _logger: Logger, dockerEnv?: DockerComposeEnvironment): Promise<void> => {
  ...
  try {
    if (wallet !== null) {
      ...
      await mainLoop(providers, rli, wallet);
    }
  } catch (e) {
